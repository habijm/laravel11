    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl  lg:px-6">
        <div class="mx-auto max-w-screen-md sm:text-center">
            ...
            <form action="/posts" method="GET">
                @if (request('category'))
                <!-- Jika ada query string 'category' pada request, buat input tersembunyi dengan nilai tersebut -->
                <input type="hidden" name="category" value="{{ request('category') }}">
                @endif
                @if (request('author'))
                <!-- Jika ada query string 'author' pada request, buat input tersembunyi dengan nilai tersebut -->
    ...
    <div class="flex justify-end">
        <div>
            <form class="max-w-sm mx-auto">
                <label for="countries" class="block mb-2 text-sm font-medium text-gray-900">Filter</label>
    ...
    <div class="py-4 px-4  mx-auto max-w-screen-xl lg:py-8 lg:px-0">
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md">
                ...
                <p class="mb-5 font-light text-gray-500"> {{ Str::limit($post['body'], 200) }}
                </p>
